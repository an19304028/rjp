...
<%@ page import="postlist.PostWrite" %>
...
<%
  ...
  comments = write.getComment(postNumber);
  post = write.getPost(postNumber);
        ...
        <div class="l-header_nav">
          <ul class="l-header_nav_items">
            ...
            <li class="l-header_nav_item">
              <form id="form1" class="form" action="TagSearchServlet" method="post">
        ...
        <c:when test="<%=hasComment%>">
          <c:forEach var="comment" items="<%=comments%>"> <%-- コメント出力部 --%>
            ...
            <div title="comment-delete" >
              ...
              <form name="comeform" method="post" onSubmit="return checkSubmit()">
                ...
                <input type="submit" value="削除" style="width: 5em;" onclick="form.action='CommentDeleteServlet'">
      ...
      <div title="comment-write"> <%-- コメント入力部 --%>
        <div class="m-roundBox m-roundBox-min-md"style="margin-top: 5em;">
          <form method="post" action="CommentWriteServlet">
            ...
            <input type="text" value="${sessionScope.user.name}" name="author" maxlength="58" placeholder="名前">
            <input type="password" style="font-family:Verdana" name="pw" maxlength="28" required placeholder="パスワード">
